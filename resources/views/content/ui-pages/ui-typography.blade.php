    ...
    <section id="html-headings-default" class="row match-height">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body pb-1">
                    <p class="card-text">
                        All HTML headings are available with light and bold font-weight. Use <code>.fw-normal</code> for
                        light heading
    ...
    <section id="customizing-headings-default" class="row match-height">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body pb-1">
                    <p class="card-text">
                        Heading elements are also changed with different color options. Use <code>.text-{colorName}</code>
                        class with
                        heading elements.
                    </p>
                </div>
    ...
    <section id="display-headings" class="card">
        ...
        <div class="card-body pb-1">
            <p class="card-text">
                ...
                heading
                to stand out, consider using a <strong>display heading</strong> — a larger, slightly more opinionated
                heading
                style.
            </p>
        </div>
    ...
    <section id="blockquotes-default" class="row match-height">
        <div class="col-sm-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">
                        Left aligned basic blockquotes. Use text utilities classes like <code>.text-center /
                            .text-end</code> as
        ...
        <div class="col-sm-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">
                        Add a <code class="highlighter-rouge">&lt;footer class="blockquote-footer"&gt;</code> for
                        identifying the
    ...
    <section id="blockquotes-styling-default" class="row match-height">
        <div class="col-sm-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">
                        Add a <code class="highlighter-rouge">.border-{start/end}-{color} .border-{start/end}-3</code>
                        helper classes,
                        where color can be any color from {{ env('APP_NAME') }} Admin color palette.
                    </p>
        ...
        <div class="col-sm-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">
                        Blockquotes with avatar. it use Media Object. You can customize image type, border alignment &
                        style.
                    </p>
                    <blockquote class="blockquote ps-1 border-start-primary border-start-3">
                        <div class="d-flex flex-row">
                            ...
                            <div class="more-info">Sometimes life is going to hit you in the head with a brick. Don't lose
                                faith.</div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12 mt-1">
                <div class="group-area">
                    <h4>Lists</h4>
                    <p>
                        All lists - <code>&lt;ul&gt;</code>, <code>&lt;ol&gt;</code>, and <code>&lt;dl&gt;</code> - have
                        their
                        margin-top removed and a <code>margin-bottom: 1rem</code>. Nested lists have no
        ...
        <div class="row match-height">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            ...
                            <code class="highlighter-rouge">list-style</code> and left margin on list items (immediate
                            children only).
                            <strong>This only applies to immediate children list items</strong>, meaning you will need to
                            add the class
            ...
            <div class="col-sm-12 col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            List of items in which the order does not explicitly matter. Use <code>.list-style-circle</code>
                            or
            ...
            <div class="col-sm-12 col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            List of items in which the order does explicitly matter. Use <code>&lt;ol
                                type="1|a|A|i|I"&gt;</code>, The
        ...
        <div class="row match-height">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            list of terms with icons, use <code>.list-style-icons</code> class. You can use any icon from
                            Vuexy Admin
                            icon types.
                        </p>
            ...
            <div class="col-md-12 mt-1">
                <div class="group-area">
                    ...
                    <p>
                        ...
                        mixins).
                        For longer terms, you can optionally add a <code class="highlighter-rouge">.text-truncate</code>
                        class to
